    ...
    var BootstrapTable = function () {
      ...
      _createClass(BootstrapTable, [{
        ...
        value: function initHeader() {
          ...
          this.options.columns.forEach(function (columns, i) {
            ...
            columns.forEach(function (column, j) {
              ...
              html.push(Utils.sprintf('<div align="center" class="th-inner %s">', _this2.options.sortable && column.sortable ? 'sortable both' : ''));
        ...
        value: function initRow(item, i, data, parentDom) {
          ...
          html.push('<tr align="center" ', Utils.sprintf(' %s', htmlAttributes.length ? htmlAttributes.join(' ') : undefined), Utils.sprintf(' id="%s"', Array.isArray(item) ? undefined : item._id), Utils.sprintf(' class="%s"', style.classes || (Array.isArray(item) ? undefined : item._class)), ' data-index="' + i + '"', Utils.sprintf(' data-uniqueid="%s"', item[this.options.uniqueId]), Utils.sprintf('%s', data_), '>');
