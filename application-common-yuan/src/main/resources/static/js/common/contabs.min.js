$(function() {
	...
	function c() {
		...
		if(options == undefined || $.trim(options).length == 0) {
			return false
		}
		// 先将单引号替换为双引号，然后再将字符串转为JSON，否则这里会报JSON转换异常错误
		options = JSON.parse(options.replace(/'/g, '"'));
		var o = $.trim(options.url),
			m = $.trim(options.id),
			l = $.trim(options.title),
			k = true;
		...
		if(k) {
			var menuUrl = rootPath + o;
			var p = '<a href="javascript:;" class="active J_menuTab" data-id="' + o + '">' + l + ' <i class="fa fa-times-circle"></i></a>';
			$(".J_menuTab").removeClass("active");
			//var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' + o + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
			var n = '<iframe class="J_iframe" name="iframe' + m + '" width="100%" height="100%" src="' +menuUrl + '" frameborder="0" data-id="' + o + '" seamless></iframe>';
