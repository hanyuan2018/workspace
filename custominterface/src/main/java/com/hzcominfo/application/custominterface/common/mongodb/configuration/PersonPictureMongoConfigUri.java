 ...
 * @author hanp
 * 
 * prefix需要与配置文件中人员照片person数据源的配置前缀对应
 *
 */
@Configuration  
@ConfigurationProperties(prefix = "spring.data.mongodb.person")
public class PersonPictureMongoConfigUri extends AbstractMongoConfigUri{
